...
class PyComponent:
    ...
    def add_reference(
        self, component: PyComponent, alias: str | None = None
    ) -> PyComponentRef: ...
    def add_connection(self, source: PyPinRange, sink: PyPinRange) -> PyConnection: ...
...
class PyConnection:
    def __init__(self, source: PyPinRange, sink: PyPinRange) -> None: ...
    @property
    def source(self) -> PyPinRange: ...
    @source.setter
    def source(self, source: PyPinRange) -> None: ...
    @property
    def sink(self) -> PyPinRange: ...
    @sink.setter
    def sink(self, sink: PyPinRange) -> None: ...
